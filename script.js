const zones = [
  {
    ...
    hint: "Workspace, account, compute, automation, and platform setup.",
  },
  {
    id: "security",
    title: "Security and secrets",
    hint: "Identity, access control, secrets, credentials, and private connectivity.",
  },
  {
    id: "batch",
    title: "Batch ingestion",
    hint: "Managed connectors, file ingestion, CDC, and scheduled loading.",
  },
  {
    id: "streaming",
    title: "Streaming and events",
    hint: "Low-latency ingestion, event streams, and incremental stream processing.",
  },
  {
    id: "storage",
    title: "Data lake storage",
    hint: "Lakehouse tables, open formats, volumes, and managed storage patterns.",
  },
  {
    id: "processing",
    title: "Processing and transformation",
    hint: "Pipelines, jobs, notebooks, SQL, Spark, and data quality rules.",
  },
  {
    id: "governance",
    title: "Governance and catalogue",
    hint: "Catalogue, discovery, lineage, federation, sharing, and policy controls.",
  },
  {
    id: "serving",
    title: "Serving and consumption",
    hint: "SQL, dashboards, BI, metrics, alerts, apps, and business-user access.",
  },
  {
    id: "ml",
  ...
  },
  {
    ...
    hint: "Run history, event logs, system tables, usage, audit, and quality monitoring.",
  },
];
